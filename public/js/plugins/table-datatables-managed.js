var TableDatatablesManaged = function () {
    ...
    var initTableProvince = function () {

        var table = $('#province_list_table');
    ...
    var initTableDistrict = function () {

        var table = $('#district_list_table');
    ...
    var initTableCity = function () {

        var table = $('#city_list_table');
    ...
    var initTableJob = function () {

        var table = $('#ads_list_table');
    ...
    var initTableCandidate = function () {

        var table = $('#candidate_list_table');
